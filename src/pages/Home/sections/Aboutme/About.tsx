...
const About = () => {
  return (
    <section id="about-me" className="section about-me-section">
      ...
      <BlocoComponent icone= 'public\assets\corrida.svg' name={"Beyond the code"} text="When I'm not developing, my main hobby is running. I'm a marathon runner. I won this distance in September 2024 and the journey to this achievement taught me a lot, such as how, without discipline and consistency, it is very difficult for anything to work out. Besides that, I like to read, listen to music, play soccer and spend quality time with my friends."/>
