...
const About = () => {
  return (
    <section id="about-me" className="section about-me-section">
      ...
      <BlocoComponent name='My life journey' text="I was born in California, USA, in 2004. As the son of Brazilian parents, I moved to Brazil when I was 7 weeks old. I always dedicated myself to school, but I never stopped enjoying this important phase of my life. I greatly value the experiences that life gives me and I am very happy with my life and the friends I have."/>
      <BlocoComponent name={"Beyond the code"} text="When I'm not developing, my main hobby is running. I'm a marathon runner. I won this distance in September 2024 and the journey to this achievement taught me a lot, such as how, without discipline and consistency, it is very difficult for anything to work out. Besides that, I like to read, listen to music, play soccer and spend quality time with my friends."/>
      <BlocoComponent name={"What motivates me"} text="My motivation comes mainly from my family. From a very young age, I learned that education is the basis of everything and that, regardless of the area I chose for my future, studying would always be extremely important. Furthermore, I really want to work on projects that truly have a positive impact on people's lives."/>
      </div>
    </section>
  );
};
